...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/webLogo.svg
  SvgGenImage get webLogo => const SvgGenImage('assets/icons/webLogo.svg');

  /// List of all assets
  List<SvgGenImage> get values => [logo, webLogo];
}
...
class Assets {
  ...
  static const String package = 'meragi';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/meragi/$_assetName';
}
